...
<section class="visit-us">
	...
	<section class="visit-us__info">
		<button class="button--white-dark-blue"><a href="<?php echo esc_html( $gmaps_address ); ?>" target="_blank"><?php esc_html_e( 'Google Maps', 'ibrpv' ); ?></a></button>
...
<section class="follow-us">
	...
	<section class="icons">
		<?php if ( $fb_icon && $fb_icon_link ) : ?>
			<div class="icons__fb">
				<a href="<?php echo esc_attr( $fb_icon_link ); ?>" target="_blank">
		...
		<?php if ( $youtube_icon && $youtube_icon_link ) : ?>
			<div class="icons__youtube">
				<a href="<?php echo esc_attr( $youtube_icon_link ); ?>" target="_blank">
		...
		<?php if ( $instagram_icon && $instagram_icon_link ) : ?>
			<div class="icons__instagram">
				<a href="<?php echo esc_attr( $instagram_icon_link ); ?>" target="_blank">
